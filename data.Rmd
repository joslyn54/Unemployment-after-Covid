...
```{r}
# read the data
df_2020 = read.csv("df2020.csv")
df_2021 = read.csv("df2021.csv")
df_2022 = read.csv("df2022.csv")
...
```{r}
# read the data
population = read.csv("upop.csv")
rate = read.csv("urate.csv")
rate_monthly = read.csv("urate_monthly.csv")
population_monthly = read.csv("upop_monthly.csv")
